...
class FtmsPowerRange {
  ...
  int clampAndRound(int watts) {
    if (minimumWatts > maximumWatts) {
      throw const FormatException('Ungültiger Trainer-Leistungsbereich.');
    }
    ...
    final maximumSteps = (maximumWatts - minimumWatts) ~/ incrementWatts;
    return minimumWatts + steps.clamp(0, maximumSteps) * incrementWatts;
  }
}

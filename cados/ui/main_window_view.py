...
class MainWindowView(QMainWindow):
    ...
    def _build_library_page(self) -> QWidget:
        ...
        self.normal_erg_button = QPushButton("Normaler ERG")
        self.normal_erg_button.setCheckable(True)
        self.normal_erg_button.setChecked(True)
        self.normal_erg_button.setProperty("modeToggle", True)
        self.normal_erg_button.setProperty("compact", True)
        self.adaptive_erg_button = QPushButton("Adaptiver ERG")
        self.adaptive_erg_button.setCheckable(True)
        self.adaptive_erg_button.setProperty("modeToggle", True)
        self.adaptive_erg_button.setProperty("compact", True)
        erg_mode_row = QHBoxLayout()
        erg_mode_row.setContentsMargins(0, 4, 0, 0)
        erg_mode_row.setSpacing(6)
        mode_label = QLabel("TRAINERSTEUERUNG")
        mode_label.setProperty("eyebrow", True)
        erg_mode_row.addWidget(mode_label)
        erg_mode_row.addWidget(self.normal_erg_button)
        erg_mode_row.addWidget(self.adaptive_erg_button)
        erg_mode_row.addStretch(1)
        ...
        preview_layout.addLayout(erg_mode_row)
    ...
    def _build_training_page(self) -> QWidget:
        ...
        self.training_normal_erg_button = QPushButton("Normaler ERG")
        self.training_normal_erg_button.setCheckable(True)
        self.training_normal_erg_button.setChecked(True)
        self.training_normal_erg_button.setProperty("modeToggle", True)
        self.training_normal_erg_button.setProperty("compact", True)
        self.training_adaptive_erg_button = QPushButton("Adaptiver ERG")
        self.training_adaptive_erg_button.setCheckable(True)
        self.training_adaptive_erg_button.setProperty("modeToggle", True)
        self.training_adaptive_erg_button.setProperty("compact", True)
        ...
        timeline_header.addWidget(self.training_normal_erg_button)
        timeline_header.addWidget(self.training_adaptive_erg_button)
